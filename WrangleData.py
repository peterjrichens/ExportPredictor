...
if __name__ == "__main__":
    ...
    dataset = 'comtrade_2011_4dg_0.tsv'
    ...
    df = df[df.oil == False] # remove Mineral fuels, oils, distillation products, etc". Need to put back for summary stats
    df = df.drop('oil',axis=1)
    save(df, 'comtrade_2011_4dg',path='data')